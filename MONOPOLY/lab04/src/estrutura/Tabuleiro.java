...
public class Tabuleiro implements Setar, Salvavel{
    ...
    public ArrayList<Propriedade> setting() {
        ...
        properties.add(new Estacao(0, "This is a free zone. None is gonna bother you here.", null, "Parking Station", -1, 0, 0));
        ...
        properties.add(new ServicoPublico(2, "Oh, you're where the mayor makes his public events. Better help your city, don't you think?", null, "Public Events Square", 200, 150, 3));
        ...
        properties.add(new Estacao(5, "The bus station is where all the fun, for the crackheads or ambitious people at least. Buckle up because the price of fun is high!", null, "Bus Station", -1, 500, 5));
        ...
        properties.add(new Estacao(10, "Watch you criminals [Rivals to the wealthiest family in town]!", null, "Police Station", -1,250, 7));
        ...
        properties.add(new ServicoPublico(14, "Oh, you're sick? I'm so sorry, blame the Mayor. Anyway, there's a lot of people ahead of you. Gotta wait [or make it private].", null, "Intensive Public Health Care", 10000, 150, 15));
        properties.add(new Estacao(15, "News Adonai TV Station where all your politics are built. You can't scape us!", null, "Adonai TV Station", 800, 1000, 9));
    ...
    public void givecards(){
        ...
        for(int i =0; i<this.getPlayers().size(); i++){
            int id = r.nextInt(this.getProperties().size());
            Propriedade property = this.getProperties().get(id);
            while (property.getOwner() != null || property.getPrice() < 0){
                id = r.nextInt(this.getProperties().size());
                property = this.getProperties().get(id);
            }
            Carta card = this.getProperties().get(id);
            (this.getPlayers().get(i).getCards()).add(card);
            card.setOwner(this.getPlayers().get(i));
        }
    }
